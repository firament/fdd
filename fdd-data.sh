...
SETUP_ROOT_LOCN="/media/sak/D1-Cache/Work-FDDA/setup-fdd";	# update to use base location
...
readonly SKYPE_PUB_KEY="${RESOURCE_FOLDER}/certs/FDD-RepoSign-pub.key";
...
#
readonly NODEJS_TAR="${APPS_BAS_SRC}/node-v8.9.1-linux-x64.tar.xz";
readonly NODEJS_PATH="${APPS_BAS_DIR}/node";
#
readonly DNETCORE_TAR="${APPS_BAS_SRC}/dotnet-sdk-2.0.3-linux-x64.tar.gz";
...
#
readonly ATOM_TAR="${APPS_DEV_SRC}/atom-1.22.1-amd64.tar.gz";
readonly ATOM_PATH="${APPS_DEV_DIR}/atom";
#
readonly VSCODE_TAR="${APPS_DEV_SRC}/code-stable-code_1.18.1-1510857349_amd64.tar.gz";
readonly VSCODE_PATH="${APPS_DEV_DIR}/VSCode-linux-x64";
#
readonly VPUML_TARFILE="${APPS_DEV_SRC}/Visual_Paradigm_CE_14_2_20171107_Linux64_InstallFree.tar.gz";
...
#
readonly MONGODB_TARFILE="${APPS_EXT_SRC}/mongodb-linux-x86_64-ubuntu1604-3.4.10.tgz";
